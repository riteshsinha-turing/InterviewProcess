...
* **Level fit** — IC ladder (J / S / St) or, for Engineering Manager candidates, EM-track scope (single-team EM / multi-team or Senior EM).
...
* **Level rule:** Hire level ≤ demonstrated level in **≥2 of 3 rounds** (Junior, and all internal candidates) or **≥3 of 4 rounds** (external Senior & Staff, and Engineering Managers).
* **Veto:** Any **No Hire on the first round** (AI-enabled coding for external; code walkthrough or PR review for internal; PR review for EM) is a veto for all levels. **No Hire on System Design - Distributed Systems** is a **strong veto** for Senior & Staff (external and internal) and for Engineering Managers, unless documented override with VP alignment. For **Engineering Manager** candidates, a **No Hire on Engineering Leadership is a veto**.
